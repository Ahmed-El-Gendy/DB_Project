...
def update_room(id, state = 'not Occupied', guest_id = None, receptionist_id = None, interval_duration = None):
    print(id, state, guest_id, receptionist_id, interval_duration)
